		...
		<div className="grid gap-6 my-16 lg:grid-cols-3">
			<div className="flex flex-col p-8 space-y-4 rounded-md dark:bg-gray-900">
				...
				<p className="text-2xl font-semibold">
					<b>Sign Up</b> Our team will connect you with an adviser to discuss your needs in detail and find the investment to suit you
				</p>
			</div>
			<div className="flex flex-col p-8 space-y-4 rounded-md dark:bg-gray-900">
				...
				<p className="text-2xl font-semibold">
					<b>Invest</b> Once you complete all KYC requirements and invest, you will be set up with a dedicated account manager
				</p>
			</div>
			<div className="flex flex-col p-8 space-y-4 rounded-md dark:bg-gray-900">
				...
				<p className="text-2xl font-semibold">
					<b>Earn Returns</b> Earn returns of 9-13% per month depending on your investment, paid out monthly
				</p>
			</div>
		</div>
	</div>
