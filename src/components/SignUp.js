...
const SignUp = () => {
   ...
   function sendEmail(e){
        emailjs.sendForm('service_vm6odzr', 'template_reka5sd', form.current, 'IT8s09TycV-9-kg4n')
          .then((result) => {
  ...
  return (
	...
	<form ref={form} className="container flex flex-col mx-auto space-y-12 ng-untouched ng-pristine ng-valid mb-10">
        ...
        <div className="space-y-2 col-span-full lg:col-span-1">
				...
				<p className="text-xs">Provide your details and someone will call you back</p>
				<p className="text-xs">By providing your details you agree to be contacted by one of our trusted third party partners</p>
			</div>
			<div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                ...
                <div className="col-span-full sm:col-span-3">
					<label htmlFor="period" className="text-sm">Investment Period</label>
                ...
                <div className="col-span-full">
					...
					{subLead && <div><p className="text-green-600">Thanks for submitting your details, You will be contacted shortly</p></div>}
				</div>
			</div>
