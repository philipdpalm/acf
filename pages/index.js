...
export default function Home() {
  return (
    ...
    content="Our team will connect you with trusted advisers from leading entities, advising on the best investment for you at no cost"
    link="signup"
    />
    <Info />
    <Steps />
    ...
    />
    <PromoReverse 
    image="https://source.unsplash.com/WYLuNY5JG4E"
    title="We Provide Completely Free Consultation Services"
    content="We match you with an investment for completely free. We pride ourselves on providing a high quality & transparent service, so you can invest in confidence and with ease to earn passive income."
    link="signup"
    />
    <SignUp />
